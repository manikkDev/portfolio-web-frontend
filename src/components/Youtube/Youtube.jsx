        ...
        <div className="youtube-top">
          ...
          <motion.div className="yt-right" variants={cardVariants}>
            ...
            <p className="yt-about">
              Roblox‑focused channel with 95k+ subscribers. Specialized in advanced edits and complex transitions, backed by 3+ years of hands‑on video editing experience.
            </p>
